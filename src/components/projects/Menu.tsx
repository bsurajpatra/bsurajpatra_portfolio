import KLEats from "../../assets/kleats.webp";
import KarmaSync from "../../assets/karmasync.webp";
import SafeWebVerify from "../../assets/safewebverify.webp";
import FaceAttend from "../../assets/FaceAttend.webp";
import SwatVsTheUndead from "../../assets/swatvstheundead.webp";
...
const Menu = [
	{
		...
		image: KLEats,
		title: "KL Eats",
		tech_stack: ["Next.js", "Node.js", "MySQL", "TailwindCSS", "Shadcn UI", "Cashfree", "Redis"],
		url: "https://kleats.in/",
	...
	},
	{
		...
		image: SafeWebVerify,
		title: "SafeWebVerify",
		tech_stack: ["React", "Node.js", "Express", "MongoDB", "Python", "Flask", "scikit-learn", "JWT"],
	...
	},
	{
		...
		image: KarmaSync,
		title: "KarmaSync",
		tech_stack: ["React", "Node.js", "Express", "MongoDB", "JWT", "SMTP", "EmailJS"],
	...
	},
	{
		...
		image: GitMatch,
		title: "GitMatch",
		tech_stack: ["Electron", "React", "Vite", "Node.js", "Express", "PDFKit", "Worker Threads"],
		url: "https://gitmatchx.netlify.app/",
		repositoryUrl: "https://github.com/bsurajpatra/GitMatch",
		description: "GitMatch is a production-ready Electron desktop application that assesses candidate capability by combining a Weighted Job Fit Engine (70%) and an Engineering Quality Engine (30%) evaluating code hygiene. It supports monorepo subdirectory scanning, concurrent bulk screening, side-by-side comparison matrices, and offline PDF report exports.",
		type: "Apps"
	},
	
	{
		...
		tech_stack: ["Unity Engine", "C#", "Unity Asset Store", "Mixamo"],
	...
	},
	{
		...
		image: FruitBlast,
		title: "Fruit Blast",
		tech_stack: ["Unity Engine", "C#", "Unity Asset Store"],
	...
	},
	{
		...
		image: ChronoLens,
		title: "ChronoLens",
		tech_stack: ["React", "MindAR.js", "Three.js", "Tailwind CSS", "Vite"],
